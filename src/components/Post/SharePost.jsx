...
//             <div className="bg-white rounded-lg p-4 w-96 d-flex flex-column overflow"  style={{ width: '300px' }}>
//                 <h2 className="text-lg font-semibold mb-4">Chia sẻ bài viết</h2>
//                 <input className="w-full shadow p-3 rounded mb-5" onChange={(e) => setCaption(e.target.value)} value={caption} name="caption" placeholder="Bạn nghĩ gì về bài viết này..."></input>
